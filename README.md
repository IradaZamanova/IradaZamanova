...
Была составлена декомпозиция на доске Miro. Были проведены следущие виды тестирования : Регрессионное тестирование, Smoke-тестирование, Функциональное тестирование, Приемочное тестирование, Тестирование API. Я протестировала документацию : очень много вопросов к требованиям. Вся тестовая документация записана в Qase IO и в Sitechko. Тест-ран так же был проведен в Qase IO и в Postman-e. 
